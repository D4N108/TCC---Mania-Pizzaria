Este projeto foi desenvolvido como parte do Trabalho de Conclusão de Curso (TCC) do terceiro módulo do curso Técnico em Informática, oferecido pela instituição **Centro de Integração Objetivo (CIOB)**.
